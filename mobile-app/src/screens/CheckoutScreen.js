...
const styles = StyleSheet.create({
  ...
  backBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(0,0,0,0.03)', justifyContent: 'center', alignItems: 'center' },
  ...
  sectionTitle: { fontSize: 18, fontWeight: '800', color: COLORS.textPrimary, marginBottom: 16, letterSpacing: -0.4 },
  ...
  summaryName: { fontSize: 14, color: COLORS.textPrimary, flex: 1 },
